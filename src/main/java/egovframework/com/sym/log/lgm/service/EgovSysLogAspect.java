 ...
 *               이삼섭 최초생성 2011. 7. 01. 이기하 패키지 분리(sym.log -> sym.log.lgm)
 *
	...
	public Object logSelect(ProceedingJoinPoint joinPoint) throws Throwable {
		...
		try {
			...
			try {
				...
				System.out.println(" [RP DEBUGER] START ============== " + EgovUserDetailsHelper.class.getName());
				...
				System.out.println(" [RP DEBUGER] FINISH ============== " + EgovUserDetailsHelper.class.getName());

			} catch (Exception e) {
				System.out.println(" [RP DEBUGER] ERROR ============== " + e.toString());
